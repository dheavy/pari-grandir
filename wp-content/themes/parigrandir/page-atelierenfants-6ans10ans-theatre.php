<?php
/**
 * Template Name: Atelier Enfants 6 ans - 10 ans > Théatre
 * Description: Template for /atelier-enfants/6-ans-10-ans/theatre/
 *
 * @package WordPress
		...
		<div class="content">
			<div class="content-area">
				...
				<section class="right-col">
					<div class="illustration illustration-9"></div>
					<div class="table fr">
